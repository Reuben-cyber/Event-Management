...
$options1[]="<option value=''></option>";
 ...
 while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
	 $options1[]="<option value='$row[sname]'>$row[sname]</option>";
 }
 mysqli_close($con);
echo "<form method='post' action='organiserslist.php'>";
echo "Select organiser: <select name='org' size='1' REQUIRED>".implode('\n',$options1)."</select>"; 
