...
$_SESSION["year"]=$yr;
 $abc="SELECT name,comments,heads, sdate, edate,imagename,Venue FROM all_events WHERE YEAR(sdate)='$yr'";
 ...
 echo "<tr>";
 echo"<caption><font size=32> REPORTS OF THE YEAR $yr </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<a href='prn_byyear.php' target='_blank'><img id='i2' src='print.png'></img></a></caption>";
 echo "<th>serial no</th><th>Name</th><th>Start Dt</th><th>End Dt</th><th>Venue</th><th>Heads</th><th>Comments</th><th>Photos</th>";
 echo "</tr>";
$i=0;
 ...
 while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
	 echo "<tr>";
	 $i++;
 echo "<td>$i</td><td>$row[name]</td><td>$row[sdate]</td><td>$row[edate]</td><td>$row[Venue]</td><td>$row[heads]</td><td>$row[comments]<td><img src='upload/$row[imagename]' class='pop-out' width='58px' height='58px'></td>";
	 echo "</tr>";
 }
 echo "</table>";
 } else {
