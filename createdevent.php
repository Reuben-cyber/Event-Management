...
if(isset($e_name)){
	$name=trim($e_name);
	$name=strip_tags($e_name);
	$name=mysqli_real_escape_string($con,$e_name);
}
if(isset($e_type)){
	$type=trim($e_type);
	$type=strip_tags($e_type);
	$type=mysqli_real_escape_string($con,$e_type);
}
$abc="INSERT INTO event_names (e_name, e_type) VALUES ( '$e_name', '$e_type')";
if(mysqli_query($con,$abc)){
	echo "New Event Created Successfully";
}
else
{
	echo "Event Cannot Be Created ".mysqli_errno($con);
}
