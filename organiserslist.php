...
$_SESSION["organiser"]=$org;
 $abc="SELECT name,comments,venue,sdate, edate,imagename FROM all_events WHERE heads='$org'";
 ...
 echo "<tr>";
  echo"<caption><font size=32> REPORTS OF THE ORGANISER $org</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<a href='prn_byorganisers.php' target='_blank'><img id='i2' src='print.png'></img></a></caption>";
 echo "<th>Serial Number</th><th>Name</th><th>Start Dt</th><th>End Dt</th><th>Venue</th><th>Comments</th><th>Photos</th>";
 echo "</tr>";
 $i=0;
 while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
	 echo "<tr>";
	 $i++;
 echo "<td>$i</td><td>$row[name]</td><td>$row[sdate]</td><td>$row[edate]</td><td>$row[venue]</td><td>$row[comments]</td><td><img src='upload/$row[imagename]' class='pop-out' width='58px' height='58px'></td>";
	 echo "</tr>";
