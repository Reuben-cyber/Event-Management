...
class PDF extends PDF_MySQL_Table
{
	function Header()
	{
    		...
    		$this->Cell(0,6,'List of Events Organised By - '.$_SESSION['organiser'],0,1,'C');
    		$this->Ln(10);
...
$query1 = "SELECT name,comments,venue,sdate, edate FROM all_events WHERE heads='$_SESSION[organiser]'";
